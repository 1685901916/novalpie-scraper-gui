...
print("=" * 60)
print("Generate Complete 535-Chapter EPUB")
print("=" * 60)
...
for ch in chapters_content:
    ...
    # 只保留1-535章
    if chapter_num == 0 or chapter_num > 535:
        continue
...
missing = sorted(set(range(1, 536)) - chapter_nums)
...
if missing:
    ...
    print(f"\nComplete: All 535 chapters present")

# 生成EPUB
print("\nStep 3: Create EPUB")
output_file = "重生路人甲成为天才_完整版.epub"

book = epub.EpubBook()
book.set_identifier('rebirth_genius_final')
